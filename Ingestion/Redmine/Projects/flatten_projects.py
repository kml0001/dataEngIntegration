...
def flatten_project(projects):
    ...
    for project in projects:
        ...
        custom_fields = flattened_project.get("custom_fields")
        parent = flattened_project.get("parent")

        # procesamiento del custom_field
        if custom_fields:
            flattened_project.pop("custom_fields")
...
export_functions.to_csv(flattened_projects, "flattened_projects.csv")
